...
/**
 * Permanently removes a file from R2. Used only for real, irreversible
 * account deletion - not the everyday soft-delete/kick flow, which
...
module.exports = { uploadToR2, getSignedFileUrl, deleteFromR2, r2 };
